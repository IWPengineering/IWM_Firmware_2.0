...
extern "C" {
    ...
    typedef enum {
        ...
        ADC1_DEPTH_SENSOR = 0x00,
        ADC1_BATTERY_SENSOR = 0x0C,
        ADC1_YAXIS_ACCELEROMETER = 0x0B,
        ADC1_XAXIS_ACCELEROMETER = 0x0F,
    ...
    typedef enum {
        ...
        DRV_ADC1_DEPTH_SENSOR = 0x00,
        DRV_ADC1_BATTERY_SENSOR = 0x0C,
        DRV_ADC1_YAXIS_ACCELEROMETER = 0x0B,
