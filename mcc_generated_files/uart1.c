...
void UART1_Initialize(void) {
    // RTSMD disabled; BRGH enabled; STSEL 1; UARTEN enabled; PDSEL 8O; LPBACK disabled; WAKE disabled; USIDL disabled; RXINV disabled; ABAUD disabled; IREN disabled; UEN TX_RX; 
    U1MODE = 0x800C;
